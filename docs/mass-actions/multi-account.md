...
Для большого числа аккаунтов используйте собственный `session.Store` или `SqliteStore`, ограничивайте количество одновременных запросов и соблюдайте правила Max.
