...
GoMax — Go-библиотека для работы с Max через TCP и WebSocket. API пакетов
доступен в [Go Reference на pkg.go.dev](https://pkg.go.dev/github.com/ebunyt-dotcom/gomax).
